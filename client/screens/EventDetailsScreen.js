...
const EventDetailsScreen = ({route, navigation}) => {
  ...
  //Event State handlers declaration
  ...
  //End of Event State handlers declaration
  ...
  //useEffect for Event States Listener to prevent creating bad-behavior data
  useEffect(() => {
    if (
  ...
  //End of return Component if the user is Admin or the creator of the Event
  //return Component if the user is not Admin nor the creator of the Event
  else
    return (
      <ImageBackground
        source={require('../assets/background_dot.png')}
  ...
  //End of return Component if the user is not Admin nor the creator of the Event
};
